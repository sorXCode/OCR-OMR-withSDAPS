...
corner_mark_min_length = 10 # mm
corner_mark_max_length = 30 #mm
...
corner_mark_search_distance = 100 # mm
...
find_box_corners_tolerance = 5 # mm
...
textbox_scan_step_x = 0.5 # mm
textbox_scan_step_y = 0.5 # mm
textbox_scan_width = 1.0 # mm
textbox_scan_height = 1.0 # mm

# The pixel coverage of the scan area that is required for it to
# be considered writing.
#textbox_scan_coverage = 0.06
textbox_scan_coverage = 0.02
...
textbox_minimum_writing_width = 2 # mm
textbox_minimum_writing_height = 2 # mm
